<?php
/**
 * Compact Text List Layout Component (Ultra-fast reading)
 *
 * @package ProthomNews
 */
...
$posts_count  = get_theme_mod("posts_count_{$block_id}", 6);
...
if (empty($title)) {
    $title = __('সংক্ষিপ্ত খবর', 'prothom-news');
}
...
<section class="category-block-wrapper">
  <div class="section-header">
    ...
    <?php if ($cat_id > 0) : ?>
      <a href="<?php echo esc_url(get_category_link($cat_id)); ?>" class="section-more-link"><?php esc_html_e('সব সংক্ষিপ্ত খবর →', 'prothom-news'); ?></a>
    <?php endif; ?>
  </div>

  <div class="compact-list-grid">
