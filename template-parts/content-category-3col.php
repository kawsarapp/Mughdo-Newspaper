<?php
/**
 * 3-Column Category Grid Block Component
 *
 * @package ProthomNews
 */
...
$block_id = isset($args['block_id']) ? $args['block_id'] : 'block_1';
...
if (empty($title)) {
    $title = __('জাতীয় সংবাদ', 'prothom-news');
}
      ...
      <article class="news-card">
        ...
        <div class="news-card-body">
          ...
          <p style="font-size:0.9rem; color:var(--text-secondary); line-height:1.4;">
            <?php echo esc_html(prothom_news_custom_excerpt(15)); ?>
          </p>
          <span style="font-size:0.75rem; color:var(--text-muted); margin-top:0.4rem;">🕒 <?php echo esc_html($time_str); ?></span>
        </div>
      </article>
