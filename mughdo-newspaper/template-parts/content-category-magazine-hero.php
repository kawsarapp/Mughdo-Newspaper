...
if (empty($title)) {
    $title = __('ম্যাগাজিন ফিচারস', 'mughdo-newspaper');
}
    ...
    ?>
      <article class="mag-hero-card">
        ...
        <div class="mag-hero-body">
          <h4 class="mag-hero-title">
            <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
          </h4>
          <p style="font-size:0.95rem; color:var(--text-secondary); margin-top:0.4rem;">
            <?php echo esc_html(prothom_news_custom_excerpt(22, $post_id)); ?>
          </p>
          <span style="font-size:0.8rem; color:var(--text-muted); margin-top:0.5rem; display:block;">🕒 <?php echo esc_html($time_str); ?></span>
        </div>
      </article>
